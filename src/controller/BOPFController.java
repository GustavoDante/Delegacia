...
public class BOPFController implements Initializable {
    ...
    void cadastrarDenuncia(ActionEvent event) {
        fachadaSistema.cadastrarDenuncia(new Denuncia(new PessoaFisica(nome.getText(), cpf.getText()), denuncia.getText(),  endereco.getText(), comboBox.getValue(), new PessoaFisica(denunciado.getText())));
